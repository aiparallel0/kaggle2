...
\newcommand{\pending}[1]{{\color{red}\textbf{[PENDING:} #1\textbf{]}}}
\newcommand{\todo}[1]{{\color{blue}\textit{[WRITE: #1]}}}

\title{The Two Questions of Trust:\\
Why a Model's Confidence Is Not Enough, and What Is}
...
\begin{itemize}
  ...
  \item Blind-spot coverage test: \pending{cases where each axis individually fails and whether composition recovers them}.
  \item Error-decorrelation measurement: \pending{empirical correlation of the two axes' error events}.
