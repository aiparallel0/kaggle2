...
def test_jumlah_besar_is_total_not_distractor() -> None:
    from models.pipeline_consensus_regex import (
        _DISTRACTOR_KW,
        _SUBTOTAL_KW,
        _TOTAL_KW,
    )
...
def test_subtotal_is_subtotal_not_total() -> None:
    from models.pipeline_consensus_regex import _SUBTOTAL_KW, _TOTAL_KW
...
def test_distractor_keywords_do_not_register_total() -> None:
    from models.pipeline_consensus_regex import _DISTRACTOR_KW, _TOTAL_KW
