...
def test_shipped_constants_exposed() -> None:
    ...
    """
    mod = importlib.import_module("models.focus_attention")
...
def test_constructor_defaults_match_shipped() -> None:
    ...
    from models.focus_inference import AttentionAssigner
    m = AttentionAssigner()
