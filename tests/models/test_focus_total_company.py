...
def test_arithmetic_witnesses_v4_fires_on_sub_plus_tax() -> None:
    ...
    from models.focus_priors import arithmetic_witnesses_v4
...
def test_forward_overrides_total_row_when_focus_t_enabled() -> None:
    ...
    torch = pytest.importorskip("torch")
    from models.focus_attention import AttentionAssigner
    from models.focus_priors import N_TEXT_PRIORS_V4, V4_WITNESS_IDX
...
def test_priors_v4_dispatch_in_pipeline_assign() -> None:
    ...
    from models.focus_pipeline import _build_priors
    from models.focus_priors import N_TEXT_PRIORS_V4
