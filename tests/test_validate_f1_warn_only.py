"""Tests for KAGGLE2_VALIDATE_F1_WARN_ONLY env-var warn-only path in validate_f1."""
...
def test_donut_low_f1_raises_by_default() -> None:
    ...
    os.environ.pop("KAGGLE2_VALIDATE_F1_WARN_ONLY", None)
...
def test_donut_low_f1_warn_only_does_not_raise() -> None:
    """With KAGGLE2_VALIDATE_F1_WARN_ONLY=1, low DONUT F1 must not raise."""
    os.environ["KAGGLE2_VALIDATE_F1_WARN_ONLY"] = "1"
    try:
...
def test_warn_only_zero_disables_override() -> None:
    """KAGGLE2_VALIDATE_F1_WARN_ONLY=0 (explicit default) still raises."""
    os.environ["KAGGLE2_VALIDATE_F1_WARN_ONLY"] = "0"
    try:
...
def test_pipeline_zero_f1_unaffected_by_warn_only() -> None:
    """KAGGLE2_VALIDATE_F1_WARN_ONLY only applies to 'donut', not 'pipeline'."""
    os.environ["KAGGLE2_VALIDATE_F1_WARN_ONLY"] = "1"
