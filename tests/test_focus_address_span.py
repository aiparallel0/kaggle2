...
def test_span_iou_boundary_ce_math() -> None:
    ...
    torch = pytest.importorskip("torch")
    from models.assigner_train import span_iou_boundary_ce
...
def test_focus_gold_span_aligns_via_best_span() -> None:
    """``_focus_gold_span`` reuses ``pipeline_oracle._best_span``."""
    from models.assigner_train import _focus_gold_span
