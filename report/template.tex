...
Our attention assigner --- a 50\,K-parameter cross-attention module
with four learned field queries --- closes the gap over rule-based
...
We document eight previously unreported implementation bugs that
