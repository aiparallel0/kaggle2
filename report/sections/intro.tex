...
\VAR{n_train_images}\,/\,\VAR{n_val_images}\,/\,\VAR{n_test_images} train\,/\,val\,/\,test split of SROIE, with
...
\item A like-for-like comparison of DONUT and a detect-then-read
  pipeline at a fixed data budget of \VAR{n_train_images} training receipts,
