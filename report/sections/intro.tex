...
iterate: retraining the 50\,K-parameter assigner takes minutes, whereas
...
\item A 50\,K-parameter cross-attention assigner with four
  learned field queries (\texttt{company}, \texttt{date},
  \texttt{address}, \texttt{total}), published with reproducible code,
  a fixed data split, and three seeds.\footnote{The repo's
  ...
  auditable.}
\item A catalogue of eight silent F1-destroying implementation bugs
