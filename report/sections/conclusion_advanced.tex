...
DONUT's \VAR{donut_f1:mean_std_pct1}
...
\VAR{pipeline_params_m}\,M).  We frame the headline contribution as
...
the \VAR{n_test_images}-image set; add a LayoutLMv3 and a zero-shot
