\item \textbf{Validation$\equiv$test leakage}
  ...
  DONUT's held-out F1 dropped from the leaked
  $\approx$\,\VAR{bug_7_f1_before} to its true post-leakage value
  $\approx$\,\VAR{donut_f1}, which reflects true
  generalisation.  \textit{Guard.} The split is
