...
Seed 42 with \texttt{core.seed.seed\_everything} and
\texttt{cudnn.deterministic=True}.  Multi-seed runs
(\{13,\,17,\,42\}) are left for future work; where more than one
seed is available we report mean\,$\pm$\,std.

\textbf{Hardware.}
RTX\,4090 on vast.ai (24\,GB VRAM); CUDA 12.x.
All telemetry sampled at 5\,s intervals
